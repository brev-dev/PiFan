...
Interpolate a target speed using TEMP_POINTS / SPEED_POINTS.
...
Drive the fan via pigpio.hardware_PWM(PWM_PIN, PWM_FREQ, duty * 10000).

Sleep (CHECK_INTERVAL) and repeat.
...
MIT or similar permissive license (adjust as desired).
